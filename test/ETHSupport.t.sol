...
contract ETHSupportTest is Test {
    ...
    function testPlaceTradeWithETH() public {
        ...
        uint256 tradeId = ethSupport.placeTradeWithETH{value: ethAmount}(
            tokenOut,
            minAmountOut,
            isInstasettlable,
            usePriceBased
    ...
    function testRevertInvalidETHAmount() public {
        ...
        ethSupport.placeTradeWithETH{value: 0}(
            tokenOut,
            1000e6,
            true,
            false
    ...
    function testCancelTrade() public {
        ...
        // Place a trade
        ethSupport.placeTradeWithETH{value: ethAmount}(
            tokenOut,
            1000e6,
            true,
            false
        ...
        // Cancel the trade
        bool success = ethSupport.cancelTrade(0);
        assertTrue(success);
    ...
    function testGetTrade() public {
        ...
        // Get trade info
        Utils.Trade memory trade = ethSupport.getTrade(0);
        assertEq(trade.owner, user);
        assertEq(trade.tokenIn, address(weth));
        assertEq(trade.tokenOut, tokenOut);
