...
LOCK_FILE="${TMPDIR:-/tmp}/liquidity-bot-v2-pull-${BOT_ID}.lock"
LOG_FILE="${TMPDIR:-/tmp}/liquidity-bot-v2-pull-${BOT_ID}.log"
...
BOT_JSON="liquidity-bot-v2/bots/${BOT_ID}.json"
STASHED_BOT_JSON=0
...
DIRTY="$(git status --porcelain --untracked-files=no | grep -v " liquidity-bot-v2/bots/${BOT_ID}.json\$" || true)"
